...
from constants import HEIGHT, STEP_ZISE, WIDTH
...
class Ball(Turtle):  
    ...
    def move_ball(self, cuadrante):
        ...
        if cuadrante == 1: 
            #sube en x e y. 
            self.ball.goto(self.position_x + STEP_ZISE, self.position_y + STEP_ZISE)    
        elif cuadrante == 2:
            #baja en x, sube en y.    
            self.ball.goto(self.position_x - STEP_ZISE, self.position_y + STEP_ZISE)
        elif cuadrante == 3:
    ...
    def outside(self): 
        ...
        if ball_x < -WIDTH//2 + STEP_ZISE or ball_x > WIDTH//2 - STEP_ZISE:
            return True 
        else: 
            return False
    ...
    def wall_collision(self):
        ...
        if ball_y >= HEIGHT//2 - STEP_ZISE or ball_y <= -HEIGHT//2 + STEP_ZISE:
            return True 
        else:
            return False
