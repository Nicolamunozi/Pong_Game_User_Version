...
print(f" esto es la posicion del paddle {player_1.pos()}, esto es la posicion de la pelota {ball.pos()}")
print(f"{ball.distance(player_1.pos())} esto es la distancia entre la bola y el paddle")
